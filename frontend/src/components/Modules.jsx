...
export function Customer() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/customers/"}
...
export function Address() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/addresses/"}
...
export function Category() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/categories/"}
...
export function Product() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/products/"}
...
export function Order() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/orders/"}
...
export function OrderItem() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/order_items/"}
...
export function Payment() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/payments/"}
...
export function Shipment() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/shipments/"}
...
export function Review() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/reviews/"}
...
export function Supplier() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/suppliers/"}
...
export function ProductSupplier() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/product_suppliers/"}
...
export function Cart() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/carts/"}
...
export function CartItem() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/cart_items/"}
...
export function Discount() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/discounts/"}
...
export function OrderDiscount() {
	return <MyTable 
		...
		url={"http://192.168.1.36:5001/order_discounts/"}
